-- Script generado desde Inventario_Jascia.csv
-- Fecha: 2025-12-01 16:11:07
-- Total: 20 equipos
...
ON CONFLICT (numero_equipo) DO UPDATE SET usuario_asignado = EXCLUDED.usuario_asignado, estado = EXCLUDED.estado;
...
-- Equipo 17
INSERT INTO public.equipos (numero_equipo, usuario_asignado, estado, ubicacion, departamento)
VALUES (17, NULL, 'Disponible', 'Oficina Principal', 'Informática')
ON CONFLICT (numero_equipo) DO UPDATE SET usuario_asignado = EXCLUDED.usuario_asignado, estado = EXCLUDED.estado;
...
-- Equipo 18
INSERT INTO public.equipos (numero_equipo, usuario_asignado, estado, ubicacion, departamento)
VALUES (18, NULL, 'Disponible', 'Oficina Principal', 'Informática')
ON CONFLICT (numero_equipo) DO UPDATE SET usuario_asignado = EXCLUDED.usuario_asignado, estado = EXCLUDED.estado;
...
INSERT INTO public.equipos (numero_equipo, usuario_asignado, estado, ubicacion, departamento)
VALUES (9, 'No Operativo', 'No Operativo', 'Oficina Principal', 'Informática')
ON CONFLICT (numero_equipo) DO UPDATE SET usuario_asignado = EXCLUDED.usuario_asignado, estado = EXCLUDED.estado;
...
-- Equipo 19
INSERT INTO public.equipos (numero_equipo, usuario_asignado, estado, ubicacion, departamento)
VALUES (19, NULL, 'Disponible', 'Oficina Principal', 'Informática')
ON CONFLICT (numero_equipo) DO UPDATE SET usuario_asignado = EXCLUDED.usuario_asignado, estado = EXCLUDED.estado;
...
-- Equipo 20
INSERT INTO public.equipos (numero_equipo, usuario_asignado, estado, ubicacion, departamento)
VALUES (20, NULL, 'Disponible', 'Oficina Principal', 'Informática')
ON CONFLICT (numero_equipo) DO UPDATE SET usuario_asignado = EXCLUDED.usuario_asignado, estado = EXCLUDED.estado;
...
VALUES
    ...
    ((SELECT id FROM public.equipos WHERE numero_equipo = 7), 'Monitor', 'VIT', NULL, NULL, NULL),
    ((SELECT id FROM public.equipos WHERE numero_equipo = 7), 'Teclado', 'IBM', 'KB0225', NULL, '114137'),
    ((SELECT id FROM public.equipos WHERE numero_equipo = 7), 'Mouse', 'VIT', 'DOK-M696', NULL, 'M56711K1044OA')
ON CONFLICT (equipo_id, tipo) DO UPDATE SET
    marca = EXCLUDED.marca,
    modelo = EXCLUDED.modelo,
    numero_serie = EXCLUDED.numero_serie,
...
VALUES
    ...
    ((SELECT id FROM public.equipos WHERE numero_equipo = 13), 'Teclado', 'VIT', 'C0915504020020A002', 'KRB316Q440U3A', 'KB-2971')
ON CONFLICT (equipo_id, tipo) DO UPDATE SET
    marca = EXCLUDED.marca,
    modelo = EXCLUDED.modelo,
    numero_serie = EXCLUDED.numero_serie,
